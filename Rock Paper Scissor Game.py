...
window = Tk()
window.title("RockPaperScissor Game")
...
image_rock2 = ImageTk.PhotoImage(Image.open("crock.png"))
image_paper2 = ImageTk.PhotoImage(Image.open("cpaper.png"))
image_scissor2 = ImageTk.PhotoImage(Image.open("cscissor.png"))
...
computer_score = Label(window, text="0", font=('arial', 40, "bold"),bg='white', fg="black")
player_score = Label(window, text="0", font=('arial', 40, "bold"),bg='white', fg="black")
player_score.grid(row=1, column=3)
computer_score.grid(row=1, column=1)

# Labels for player and computer indicators
player_indicator = Label(window, text="PLAYER", font=("arial", 40, "bold"), fg="black")
computer_indicator = Label(window, text="COMPUTER", font=("arial", 40, "bold"), fg="black")
...
def updateMessage(msg):
    colors = {
        'Computer Wins': 'dark red',
        "It's a tie": 'dark blue',
    }
    color = colors.get(msg, 'dark green')
...
button_rock = Button(window, width=16, height=3, text="ROCK", font=("arial", 20, "bold"),
                     bg="grey", fg="white", command=lambda: choice_update("rock"))
button_paper = Button(window, width=16, height=3, text="PAPER", font=("arial", 20, "bold"),
                      bg="grey", fg="white", command=lambda: choice_update("paper"))
button_scissor = Button(window, width=16, height=3, text="SCISSOR", font=("arial", 20, "bold"),
                        bg="grey", fg="white", command=lambda: choice_update("scissor"))
...
final_message = Label(window, font=("arial", 40, "bold"), bg="white")
